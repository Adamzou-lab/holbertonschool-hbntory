...
- **`docker compose up` bout-en-bout** : chaque service a été vérifié individuellement et en
  interaction directe (backoffice ↔ MCP ↔ Service IA ↔ Client web) avec de vraies requêtes,
  mais l'orchestration complète via Docker Compose sur un environnement neuf reste à confirmer.
